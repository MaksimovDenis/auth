// Code generated by http://github.com/gojuno/minimock (v3.3.8). DO NOT EDIT.

package mocks

//go:generate minimock -i github.com/MaksimovDenis/auth/internal/service.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
type UserServiceMock struct {
	...
	funcCreate          func(ctx context.Context, create *model.UserCreate) (i1 int64, err error)
	inspectFuncCreate   func(ctx context.Context, create *model.UserCreate)
	afterCreateCounter  uint64
	beforeCreateCounter uint64
	CreateMock          mUserServiceMockCreate

	funcDelete          func(ctx context.Context, id int64) (ep1 *empty.Empty, err error)
	...
	funcUpdate          func(ctx context.Context, update *model.UserUpdate) (ep1 *empty.Empty, err error)
	inspectFuncUpdate   func(ctx context.Context, update *model.UserUpdate)
...
func (mmCreate *mUserServiceMockCreate) Expect(ctx context.Context, create *model.UserCreate) *mUserServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserServiceMockCreateParams{ctx, create}
...
// ExpectCreateParam2 sets up expected param create for UserService.Create
func (mmCreate *mUserServiceMockCreate) ExpectCreateParam2(create *model.UserCreate) *mUserServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
	...
	mmCreate.defaultExpectation.paramPtrs.create = &create

	return mmCreate
}

// Inspect accepts an inspector function that has same arguments as the UserService.Create
func (mmCreate *mUserServiceMockCreate) Inspect(f func(ctx context.Context, create *model.UserCreate)) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, create *model.UserCreate) (i1 int64, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserServiceMockCreate) When(ctx context.Context, create *model.UserCreate) *UserServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &UserServiceMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &UserServiceMockCreateParams{ctx, create},
	}
...
func (mmCreate *UserServiceMock) Create(ctx context.Context, create *model.UserCreate) (i1 int64, err error) {
	mm_atomic.AddUint64(&mmCreate.beforeCreateCounter, 1)
	defer mm_atomic.AddUint64(&mmCreate.afterCreateCounter, 1)

	if mmCreate.inspectFuncCreate != nil {
		mmCreate.inspectFuncCreate(ctx, create)
	}

	mm_params := UserServiceMockCreateParams{ctx, create}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockCreateParams{ctx, create}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.create != nil && !minimock.Equal(*mm_want_ptrs.create, mm_got.create) {
				mmCreate.t.Errorf("UserServiceMock.Create got unexpected parameter create, want: %#v, got: %#v%s\n", *mm_want_ptrs.create, mm_got.create, minimock.Diff(*mm_want_ptrs.create, mm_got.create))
			}
	...
	if mmCreate.funcCreate != nil {
		return mmCreate.funcCreate(ctx, create)
	}
	mmCreate.t.Fatalf("Unexpected call to UserServiceMock.Create. %v %v", ctx, create)
	return
}
...
func (mmDelete *mUserServiceMockDelete) Return(ep1 *empty.Empty, err error) *UserServiceMock {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("UserServiceMock.Delete mock is already set by Set")
	}
	...
	mmDelete.defaultExpectation.results = &UserServiceMockDeleteResults{ep1, err}
	return mmDelete.mock
}

// Set uses given function f to mock the UserService.Delete method
func (mmDelete *mUserServiceMockDelete) Set(f func(ctx context.Context, id int64) (ep1 *empty.Empty, err error)) *UserServiceMock {
	if mmDelete.defaultExpectation != nil {
...
func (e *UserServiceMockDeleteExpectation) Then(ep1 *empty.Empty, err error) *UserServiceMock {
	e.results = &UserServiceMockDeleteResults{ep1, err}
	return e.mock
}

// Delete implements service.UserService
func (mmDelete *UserServiceMock) Delete(ctx context.Context, id int64) (ep1 *empty.Empty, err error) {
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, update *model.UserUpdate) *mUserServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserServiceMockUpdateParams{ctx, update}
...
// ExpectUpdateParam2 sets up expected param update for UserService.Update
func (mmUpdate *mUserServiceMockUpdate) ExpectUpdateParam2(update *model.UserUpdate) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, update *model.UserUpdate)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Return(ep1 *empty.Empty, err error) *UserServiceMock {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	mmUpdate.defaultExpectation.results = &UserServiceMockUpdateResults{ep1, err}
	return mmUpdate.mock
}

// Set uses given function f to mock the UserService.Update method
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, update *model.UserUpdate) (ep1 *empty.Empty, err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, update *model.UserUpdate) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &UserServiceMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &UserServiceMockUpdateParams{ctx, update},
	}
...
func (e *UserServiceMockUpdateExpectation) Then(ep1 *empty.Empty, err error) *UserServiceMock {
	e.results = &UserServiceMockUpdateResults{ep1, err}
	return e.mock
}

// Update implements service.UserService
func (mmUpdate *UserServiceMock) Update(ctx context.Context, update *model.UserUpdate) (ep1 *empty.Empty, err error) {
	...
	mm_params := UserServiceMockUpdateParams{ctx, update}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockUpdateParams{ctx, update}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.update != nil && !minimock.Equal(*mm_want_ptrs.update, mm_got.update) {
				mmUpdate.t.Errorf("UserServiceMock.Update got unexpected parameter update, want: %#v, got: %#v%s\n", *mm_want_ptrs.update, mm_got.update, minimock.Diff(*mm_want_ptrs.update, mm_got.update))
			}
	...
	mmUpdate.t.Fatalf("Unexpected call to UserServiceMock.Update. %v %v", ctx, update)
	return
}
