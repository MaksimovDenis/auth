...
//go:generate minimock -i github.com/MaksimovDenis/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
func (mmCreate *mUserRepositoryMockCreate) Expect(ctx context.Context, create *model.UserCreate) *mUserRepositoryMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserRepositoryMockCreateParams{ctx, create}
...
// ExpectCreateParam2 sets up expected param create for UserRepository.Create
func (mmCreate *mUserRepositoryMockCreate) ExpectCreateParam2(create *model.UserCreate) *mUserRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserRepositoryMockCreate) Inspect(f func(ctx context.Context, create *model.UserCreate)) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Set(f func(ctx context.Context, create *model.UserCreate) (i1 int64, err error)) *UserRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserRepositoryMockCreate) When(ctx context.Context, create *model.UserCreate) *UserRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &UserRepositoryMockCreateParams{ctx, create},
	}
...
func (mmCreate *UserRepositoryMock) Create(ctx context.Context, create *model.UserCreate) (i1 int64, err error) {
	...
	mm_params := UserRepositoryMockCreateParams{ctx, create}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockCreateParams{ctx, create}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.create != nil && !minimock.Equal(*mm_want_ptrs.create, mm_got.create) {
				mmCreate.t.Errorf("UserRepositoryMock.Create got unexpected parameter create, want: %#v, got: %#v%s\n", *mm_want_ptrs.create, mm_got.create, minimock.Diff(*mm_want_ptrs.create, mm_got.create))
			}
	...
	mmCreate.t.Fatalf("Unexpected call to UserRepositoryMock.Create. %v %v", ctx, create)
	return
}
...
func (mmDelete *mUserRepositoryMockDelete) Return(ep1 *empty.Empty, err error) *UserRepositoryMock {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("UserRepositoryMock.Delete mock is already set by Set")
	}
...
func (mmDelete *mUserRepositoryMockDelete) Set(f func(ctx context.Context, id int64) (ep1 *empty.Empty, err error)) *UserRepositoryMock {
	if mmDelete.defaultExpectation != nil {
...
func (e *UserRepositoryMockDeleteExpectation) Then(ep1 *empty.Empty, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockDeleteResults{ep1, err}
	return e.mock
}

// Delete implements repository.UserRepository
func (mmDelete *UserRepositoryMock) Delete(ctx context.Context, id int64) (ep1 *empty.Empty, err error) {
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, update *model.UserUpdate) *mUserRepositoryMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserRepositoryMockUpdateParams{ctx, update}
...
// ExpectUpdateParam2 sets up expected param update for UserRepository.Update
func (mmUpdate *mUserRepositoryMockUpdate) ExpectUpdateParam2(update *model.UserUpdate) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, update *model.UserUpdate)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Return(ep1 *empty.Empty, err error) *UserRepositoryMock {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, update *model.UserUpdate) (ep1 *empty.Empty, err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, update *model.UserUpdate) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &UserRepositoryMockUpdateParams{ctx, update},
	}
...
func (e *UserRepositoryMockUpdateExpectation) Then(ep1 *empty.Empty, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockUpdateResults{ep1, err}
	return e.mock
}

// Update implements repository.UserRepository
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, update *model.UserUpdate) (ep1 *empty.Empty, err error) {
	...
	mm_params := UserRepositoryMockUpdateParams{ctx, update}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockUpdateParams{ctx, update}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.update != nil && !minimock.Equal(*mm_want_ptrs.update, mm_got.update) {
				mmUpdate.t.Errorf("UserRepositoryMock.Update got unexpected parameter update, want: %#v, got: %#v%s\n", *mm_want_ptrs.update, mm_got.update, minimock.Diff(*mm_want_ptrs.update, mm_got.update))
			}
	...
	mmUpdate.t.Fatalf("Unexpected call to UserRepositoryMock.Update. %v %v", ctx, update)
	return
}
